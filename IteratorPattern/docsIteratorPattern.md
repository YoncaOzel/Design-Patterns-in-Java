...
│ │    ├────────────────────────┤  ├────────────────────┤      │  │
│ │    │ - menuItems:           │  │ - MAX_ITEMS: int   │      │  │
│ │    │   ArrayList<MenuItem>  │  │ - numberOfItems:   │      │  │
│ │    ├────────────────────────┤  │   int              │      │  │
│ │    │ + addItem(...): void   │  │ - menuItems:       │      │  │
│ │    │ + createIterator():    │  │   MenuItem[]       │      │  │
│ │    │   Iterator<MenuItem>   │  ├────────────────────┤      │  │
│ │    └────────────────────────┘  │ + addItem(...):    │      │  │
│ │                                │   void             │      │  │
│ │                                │ + createIterator():│      │  │
...
│  │  ├────────────────────────────────────────────────────────────┤ │  │
│  │  │ + printMenu(): void                                        │ │  │
│  │  │ - printMenu(iterator: Iterator<MenuItem>): void           │ │  │
│  │  └────────────────────────────────────────────────────────────┘ │  │
│  │                                                                   │  │
│  │    uses ◄──────────┬──────────┬──────────────────────┐           │  │
│  │                    │          │                      │           │  │
...
│                                                                          │
│  **Yazılı Akış:**                                                        │
│  1. Waitress, Menu'den Iterator ister                                   │
│  2. Menu (PancakeHouseMenu veya DinerMenu), Iterator döner              │
│  3. Waitress, Iterator ile MenuItem'leri sıra ile alır                  │
│  4. Her MenuItem'nin özelliklerine (name, price, desc.) erişir          │
│                                                                          │
└──────────────────────────────────────────────────────────────────────────┘
```
